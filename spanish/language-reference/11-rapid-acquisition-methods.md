...
- The scenarios are narratives: each has characters, situations, and progressions.
...
**How Velocidad integrates it:**
- The `chunks/reference.md` file IS a sentence mine, organized by scenario.
...
- Scenarios have 5 levels precisely to calibrate input difficulty.
...
**How Velocidad integrates it:**
- TPR commands appear in scenario contexts: house workers (directions), McDonald's (pointing, gesturing).
- The "casa" scenario is heavily spatial — perfect for TPR commands.
